	...
	<div class="container-fluid fixed-top">
		...
		<div class="container px-0">
			<nav class="navbar navbar-light bg-white navbar-expand-xl">
				<a href="main.jsp" class="navbar-brand"><h1
						class="text-primary display-6">NaeDdoCo Pills</h1></a>
			...
			<div class="row justify-content-center">
				<div class="col-lg-6">
					<form action="login.do" method="POST">
						...
						<input class="btn border-secondary rounded-pill py-3 px-5" type="submit" value="로그인">
						<a class="btn border-secondary rounded-pill py-3 px-5" href="join.jsp">회원가입</a>
					</form>
				</div>
			</div>
			<hr>		
				<a class="btn border-secondary rounded-pill py-3 px-5" href="#">카카오 로그인</a>
		</div>
	</div>
	<!-- 로그인 폼 끝 -->
